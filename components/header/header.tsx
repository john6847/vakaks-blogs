...
export const Header = () => {
  return (
    <header className='relative sm:m-8 m-4 sm:p-6 p-4 2xl:container 2xl:mx-auto rounded-3xl bg-background/60 backdrop-blur-lg z-50'>
      <div className='flex justify-between sm:gap-8 gap-4 w-full'>
